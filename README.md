...
This repository contains information about REST API support for Barracuda WAF-As-A-Service and Barracuda WAF. Also included are code samples to show how to use these APIs.
