...
$publicip_output = Get-AzureRmVM -ResourceGroupName 'test' -Name 'testing' | Get-AzureRmPublicIpAddress -Name 'test-ip'
...
{
$eulasign = @{name_sign=<name>; email_sign="<email-name>"; company_sign="company-name"; eula_hash_val=ed4480205f84cde3e6bdce0c987348d1d90de9db; action=save_signed_eula}
